    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command_response', models.TextField(choices=[('Я бот который родился в процессе написания тестового задания. Расскажу интересные новости и скажу какая погода. Cписок рабочих команд ты увидешь заюзая команду: /help Надеюсь тебе понравится))', 'старт'), ('/start: Скажу привет и расскажу кратко, что умею, \n/help: Расскажу подробно какими командами ты можешь воспользоваться, \n/weather: расскажу какая погода в этом городе, \n/news: Интересные новости слушать будем??!!1! ', 'хелпа'), ('Я ща тебе такое расскажу, только сначала присядь ', 'новости'), ('Такс а ты вообще знаешь че там по погоде? Ща буду рассказывать ', 'погода')], verbose_name='Команда для бота')),
